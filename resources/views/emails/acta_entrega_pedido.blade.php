        ...
        <div class="body">
            ...
            <div class="check-box">
                ...
                <span class="check-text">
                    Se confirmó la entrega de tu pedido <strong>#{{ $codigoPedido }}</strong>. Adjunto encontrarás
            ...
            <div class="info-box">
                <p>
                    ✍️ Por favor imprime, firma y haz llegar el acta adjunta al momento de recibir el pedido.
                </p>
            </div>
