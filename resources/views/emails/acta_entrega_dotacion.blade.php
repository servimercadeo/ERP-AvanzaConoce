...
<head>
    ...
    <title>Acta de entrega de dotación</title>
    <style>
...
<body>
    <div class="wrapper">
        <div class="header">
            <h1>{{ $empresa }}</h1>
            <p>Gestión Logística y Almacenamiento</p>
        </div>
        ...
        <div class="body">
            ...
            <div class="check-box">
                ...
                <span class="check-text">
                    Se confirmó tu pedido de dotación <strong>#{{ $codigoPedido }}</strong>. Adjunto encontrarás
            ...
            <div class="info-box">
                <p>
                    ✍️ Por favor imprime, firma y haz llegar el acta adjunta al momento de recibir tu dotación.
                </p>
            </div>
