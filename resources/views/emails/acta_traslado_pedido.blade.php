...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            <p class="greeting">Hola, {{ $nombreResponsable }},</p>

            <div class="check-box">
                <span class="check-icon">🚚</span>
                <span class="check-text">
                    Tu pedido <strong>#{{ $codigoPedido }}</strong> se surtió mediante un traslado de inventario
                    desde otra sede. Adjunto encontrarás el acta de traslado correspondiente.
                </span>
            </div>

            <div class="info-box">
                <p>
                    ✍️ Por favor conserva el acta adjunta como respaldo del movimiento de inventario.
                </p>
            </div>
        ...
        <div class="footer">
            <p>
                ...
                Si tienes dudas, comunícate con el área de Compras.<br>
