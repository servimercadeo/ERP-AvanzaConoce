...
<body>
    <div class="wrapper">
        <div class="header">
            <h1>{{ $empresa }}</h1>
            <p>Asignación de Inventario</p>
        </div>

        <div class="body">
            <p class="greeting">Hola, {{ $nombreEmpleado }},</p>

            <div class="check-box">
                <span class="check-icon">🧰</span>
                <span class="check-text">
                    Se registró a tu nombre la asignación <strong>{{ $referencia }}</strong>. Adjunto encontrarás
                    el acta de entrega de elementos correspondiente.
                </span>
            </div>

            <div class="info-box">
                <p>
                    ✍️ Por favor imprime, firma y haz llegar el acta adjunta al momento de recibir el elemento.
                </p>
            </div>
        ...
        <div class="footer">
            <p>
                Este correo fue enviado por {{ $empresa }}.<br>
                Si tienes dudas, comunícate con el área encargada del inventario.<br>
