...
<body>
    <div class="wrapper">
        ...
        <div class="body">
            ...
            <p class="message">
                ¡Gracias por completar tu registro! El siguiente paso es cargar los documentos requeridos para finalizar tu proceso de contratación.
            </p>

            <div class="info-box">
                <p>
                    Por favor ten a mano los siguientes documentos antes de ingresar al portal:<br><br>
                    • Documento de identidad (ambas caras)<br>
                    • Hoja de vida actualizada<br>
                    • Certificados de estudio<br>
                    • Certificados laborales<br>
                    • Certificación EPS<br>
                    • Certificación Fondo de Pensiones<br>
                    • Formato Hoja de Vida S&amp;M (si aplica)
                </p>
            </div>

            <p class="message">
                Haz clic en el botón a continuación para subir tus documentos:
            </p>

            <div class="btn-wrap">
                <a href="{{ $uploadUrl }}" class="btn">Cargar mis documentos</a>
            </div>
