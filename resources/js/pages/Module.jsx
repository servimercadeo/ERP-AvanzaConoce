...
function resolveCrud(moduleId, archivoId) {
  switch (moduleId) {
    ...
    case 'administrativo':
      switch (archivoId) {
        case 'empleados':  return EmpleadosCrud;
    ...
    <Layout>
      <div style={{ width: '100%', maxWidth: '1200px', margin: '0 auto' }}>
        ...
        {archivosDirectos.length > 0 && (
          <div style={{ marginTop: mod.submods?.length > 0 ? 36 : 28 }}>
                ...
                return (
                  ...
                  >
                    ...
                    {hasCrud && (
                      <span style={{
                        ...S.tabBadge,
                        background: activa ? 'var(--primary)' : '#cce8e4',
                        color: activa ? '#fff' : 'var(--primary-dark)',
                      }}>
                        CRUD
                      </span>
                    )}
                ...
                <>
                  <div style={{ marginBottom: 24 }}>
                    ...
                    <p style={{ color: 'var(--text-muted)', fontSize: '0.88rem' }}>
                      {mod.label} · Gestión completa de {archivoActual?.label?.toLowerCase()}
                    </p>
                  </div>
                  <CrudComponent />
                </>
