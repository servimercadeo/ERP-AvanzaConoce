...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE `{$prefix}pedidos_compra` MODIFY tipo_responsable ENUM('Empleado','Subagente','Aliado') NOT NULL");
        DB::table('pedidos_compra')->where('tipo_responsable', 'Subagente')->update(['tipo_responsable' => 'Aliado']);
        DB::statement("ALTER TABLE `{$prefix}pedidos_compra` MODIFY tipo_responsable ENUM('Empleado','Aliado') NOT NULL");
    }
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE `{$prefix}pedidos_compra` MODIFY tipo_responsable ENUM('Empleado','Subagente') NOT NULL");
    }
};
